...
char* const info[] PROGMEM = { "FT800 Signals Application",
...
{
  ft_int16_t i,xx=0;
  ft_uint16_t tval,th_cts=0,amp;
  ft_uint8_t  temp[FT_DispHeight],hide_x=0,tag,opt=3;
// ========  Bg =========================================================
